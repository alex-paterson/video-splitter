...
1. Call topic_to_compilation with the topic path. If the invocation mentions a max-seconds ceiling, pass it as maxSeconds. Forward userPrompt if provided. It writes a .compilation.json next to the topic.
